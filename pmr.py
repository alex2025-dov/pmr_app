...
# Callback to reset confirmation state
...
league = st.sidebar.selectbox('Select a League', ['LaLiga 2024-25', 'Premier League 2024-25'], key='league', on_change=reset_confirmation)

# Step 2: Game Week selection
gw_list = list(range(1, 39))
gm_wk = st.sidebar.selectbox('Select a Game Week', gw_list, key='game_week', on_change=reset_confirmation)
...
htn = st.sidebar.selectbox('Select Home Team Name', team_list, key='home_team', index=None, on_change=reset_confirmation)
atn = st.sidebar.selectbox('Select Away Team Name', team_list, key='away_team', index=None, on_change=reset_confirmation)

if league and gm_wk and htn and atn:
    ...
    if st.session_state.confirmed:
        ...
        def get_event_data(league, gm_wk, htn, atn):
            ...
            match_html_path = f"https://raw.githubusercontent.com/adnaaan433/Match_Report_App_Database/refs/heads/main/{league}/GW{gm_wk}/{htn}_vs_{atn}.html"
        ...
        df, teams_dict, players_df = get_event_data(league, gm_wk, htn, atn)
        ...
        st.text(f'GameWeek {gm_wk}, {league}')
        ...
        with tab1:
            ...
            if an_tp == 'Passing Network':
                ...
                pn_time_phase = st.pills("", ['Full Time', 'First Half', 'Second Half'], default='Full Time')
            ...
            if an_tp == 'Defensive Actions Heatmap':
                ...
                dah_time_phase = st.pills("", ['Full Time', 'First Half', 'Second Half'], default='Full Time')
            ...
            if an_tp == 'Progressive Passes':
                ...
                pp_time_phase = st.pills("", ['Full Time', 'First Half', 'Second Half'], default='Full Time')
            ...
            if an_tp == 'Progressive Carries':
                ...
                pc_time_phase = st.pills("", ['Full Time', 'First Half', 'Second Half'], default='Full Time')
            ...
            if an_tp == 'Shotmap':
                ...
                sm_time_phase = st.pills("", ['Full Time', 'First Half', 'Second Half'], default='Full Time')
            ...
            if an_tp == 'GK Saves':
                ...
                gp_time_phase = st.pills("", ['Full Time', 'First Half', 'Second Half'], default='Full Time')
            ...
            if an_tp == 'Final Third Entries':
                ...
                fig, axs = plt.subplots(1,2, figsize=(15, 10), facecolor=bg_color)
                fthE_time_phase = st.pills("", ['Full Time', 'First Half', 'Second Half'], default='Full Time')
            ...
            if an_tp == 'Box Entries':
                ...
                bent_time_phase = st.pills("", ['Full Time', 'First Half', 'Second Half'], default='Full Time')
            ...
            if an_tp == 'High-Turnovers':
                ...
                fig, axs = plt.subplots(1,2, figsize=(15, 10), facecolor=bg_color)
                hto_time_phase = st.pills("", ['Full Time', 'First Half', 'Second Half'], default='Full Time')
            ...
            if an_tp == 'Chances Creating Zones':
                ...
                fig, axs = plt.subplots(1,2, figsize=(15, 10), facecolor=bg_color)
                cc_time_phase = st.pills("", ['Full Time', 'First Half', 'Second Half'], default='Full Time')
            ...
            if an_tp == 'Crosses':
                ...
                fig, axs = plt.subplots(1,2, figsize=(15, 10), facecolor=bg_color)
                crs_time_phase = st.pills("", ['Full Time', 'First Half', 'Second Half'], default='Full Time')
            ...
            if an_tp == 'Team Domination Zones':
                ...
                tdz_time_phase = st.pills("", ['Full Time', 'First Half', 'Second Half'], default='Full Time')
        ...
        with tab3:
            ...
            if stats_type == "Key Stats":
                ...
                himage = urlopen(f"https://images.fotmob.com/image_resources/logo/teamlogo/{hftmb_tid}.png")
                himage = Image.open(himage)
                ax_himage = add_image(himage, fig, left=0.16, bottom=0.83, width=0.11, height=0.11)
                
                aimage = urlopen(f"https://images.fotmob.com/image_resources/logo/teamlogo/{aftmb_tid}.png")
                aimage = Image.open(aimage)
                ax_aimage = add_image(aimage, fig, left=0.74, bottom=0.83, width=0.11, height=0.11)
            ...
            if stats_type == "Shooting Stats":
                ...
                fig_text(0.5, 0.98, f'<{hteamName} {hgoal_count}> - <{agoal_count} {ateamName}>', highlight_textprops=[{'color':hcol}, {'color':acol}], fontsize=27, fontweight='bold', ha='center', va='center', ax=fig)
            ...
            if stats_type == "Defensive Stats":
                ...
                fig_text(0.5, 1.01, f'<{hteamName} {hgoal_count}> - <{agoal_count} {ateamName}>', highlight_textprops=[{'color':hcol}, {'color':acol}], fontsize=27, fontweight='bold', ha='center', va='center', ax=fig)
            ...
            if stats_type == "Other Stats":
                ...
                fig_text(0.5, 1.02, f'<{hteamName} {hgoal_count}> - <{agoal_count} {ateamName}>', highlight_textprops=[{'color':hcol}, {'color':acol}], fontsize=27, fontweight='bold', ha='center', va='center', ax=fig)
